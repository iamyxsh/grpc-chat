...
func (x *JoinChannelRequest) GetFrom() string {
	if x != nil {
		return x.From
	}
	return ""
...
func (x *JoinChannelRequest) GetTo() string {
	if x != nil {
		return x.To
	}
	return ""
...
func (x *JoinChannelResponse) GetRes() bool {
	if x != nil {
		return x.Res
	}
	return false
...
var file_chatpb_chat_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x12, 0x06, 0x63, 0x68, 0x61, 0x74, 0x70, 0x62, 0x22, 0x47, 0x0a, 0x07, 0x4d,
	...
	0x73, 0x61, 0x67, 0x65, 0x22, 0x38, 0x0a, 0x12, 0x4a, 0x6f, 0x69, 0x6e, 0x43, 0x68, 0x61, 0x6e,
	...
	0x0a, 0x02, 0x74, 0x6f, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x02, 0x74, 0x6f, 0x22, 0x27,
	...
	0x28, 0x08, 0x52, 0x03, 0x72, 0x65, 0x73, 0x32, 0x49, 0x0a, 0x0b, 0x43, 0x68, 0x61, 0x74, 0x53,
	0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x3a, 0x0a, 0x10, 0x42, 0x72, 0x6f, 0x61, 0x64, 0x63,
	0x61, 0x73, 0x74, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x12, 0x0f, 0x2e, 0x63, 0x68, 0x61,
	0x74, 0x70, 0x62, 0x2e, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x1a, 0x0f, 0x2e, 0x63, 0x68,
	0x61, 0x74, 0x70, 0x62, 0x2e, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x22, 0x00, 0x28, 0x01,
	0x30, 0x01, 0x42, 0x09, 0x5a, 0x07, 0x2f, 0x63, 0x68, 0x61, 0x74, 0x70, 0x62, 0x62, 0x06, 0x70,
...
var file_chatpb_chat_proto_goTypes = []interface{}{
	...
	(*JoinChannelRequest)(nil),  // 1: chatpb.JoinChannelRequest
	(*JoinChannelResponse)(nil), // 2: chatpb.JoinChannelResponse
}
var file_chatpb_chat_proto_depIdxs = []int32{
	0, // 0: chatpb.ChatService.BroadcastMessage:input_type -> chatpb.Message
	0, // 1: chatpb.ChatService.BroadcastMessage:output_type -> chatpb.Message
